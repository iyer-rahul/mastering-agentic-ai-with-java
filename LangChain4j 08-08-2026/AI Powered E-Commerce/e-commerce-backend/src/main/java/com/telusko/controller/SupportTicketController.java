...
public class SupportTicketController {
    ...
    /**
     * The AI-drafted reply for a ticket.
     * <p>
     * It is deliberately excluded from the ticket JSON, because the customer's own ticket
     * endpoints serialise the same entity and an internal draft is not for them to read. This
     * admin-only route is how the back office gets it.
     */
