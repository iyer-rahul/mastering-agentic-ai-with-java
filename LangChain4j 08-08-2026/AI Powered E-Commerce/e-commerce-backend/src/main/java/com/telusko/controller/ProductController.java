...
public class ProductController {
    ...
    public ResponseEntity<Map<String,String>> generateDescription(@RequestParam String name, @RequestParam String category,
    ...
    public ResponseEntity<Map<String,byte[]>> generateImage(@RequestParam String name, @RequestParam String category,
                                           @RequestParam String description, @RequestParam String brand) {

        // The service takes (name, category, description, brand). Passing description where
        // category belongs made the prompt describe the wrong thing.
